...
class Post extends Model
{
    ...
    protected $relationHandles = [
        'type' => [CharacterType::class, 'associate'],
        'status' => [CharacterStatus::class, 'associate'],
        'creators' => [User::class, 'sync'],
        'intro' => [Comic::class, 'associate'],
        'icon' => [ManagedFile::class, 'save'],
        'designSheet' => [ManagedFile::class, 'save'],
        'supplementaryArt' => [ManagedFile::class, 'attach'],
    ];
